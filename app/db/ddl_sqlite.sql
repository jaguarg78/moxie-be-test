...
INSERT INTO appointments(start_time, medspa_id, customer_id) VALUES('2025-03-01 14:00:00', (SELECT id FROM medspas WHERE name = 'medspa_1'), (SELECT id FROM customers WHERE username = 'username_1'));
INSERT INTO appointments(start_time, medspa_id, customer_id) VALUES('2025-03-02 14:00:00', (SELECT id FROM medspas WHERE name = 'medspa_1'), (SELECT id FROM customers WHERE username = 'username_1'));
INSERT INTO appointments(start_time, medspa_id, customer_id) VALUES('2025-03-03 14:00:00', (SELECT id FROM medspas WHERE name = 'medspa_1'), (SELECT id FROM customers WHERE username = 'username_1'));
